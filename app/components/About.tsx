      ...
      <div className="container mx-auto px-6">
        <ScrollAnimation animation="fade-in">
          <div className="section-title">
            <h2>About Me</h2>
            <p>
              Learn more about my skills, experience, and passion for technology
            </p>
          </div>
        </ScrollAnimation>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <ScrollAnimation animation="slide-left" className="space-y-6">
            ...
            <p className="text-light/80 text-lg leading-relaxed">
              {"I believe technology can transform ideas into reality, and I'm constantly exploring new ways to push the boundaries of what is possible on the web."}
            </p>
